...
const initialCategories: Category[] = [
  { id: 1, name: "Web Tasarım", slug: "web-tasarim", count: 6 },
  { id: 2, name: "E-Ticaret", slug: "e-ticaret", count: 4 },
  { id: 3, name: "Mobil Uygulama", slug: "mobil-uygulama", count: 3 },
  { id: 4, name: "Kurumsal", slug: "kurumsal", count: 5 },
  { id: 5, name: "Landing Page", slug: "landing-page", count: 4 },
]
  ...
  return (
    ...
    >
      <AdminPageHeader
        ...
        description="Portfolio projeleri için kategorileri yönetin"
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-[var(--admin-border)]">
              ...
              {["Kategori Adı", "Slug", "Proje Sayısı", "İşlemler"].map((h) => (
